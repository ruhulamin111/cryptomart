    ...
    return (
        <Col className='coin-details-container'>
            <Col className='coin-heading-container'>
                ...
                <p>{cryptoDetails?.name} live price  in US dollars. View value statistic, market cap and supply. </p>
            </Col>
            ...
            <LineChart cryptoDetails={cryptoDetails} currentPrice={millify(cryptoDetails.price)} coinName={millify(cryptoDetails.name)} />
